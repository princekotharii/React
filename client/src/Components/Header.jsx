  ...
  return (
    <nav className="bg-transparent   top-0 left-0 w-full z-50 absolute text-white p-9">
      ...
      <div className="max-w-7xl mx-auto px-4 flex items-center justify-between h-16">
        ...
        <Link to='/'>
          <svg className="cursor-pointer" class="icon" focusable="false" aria-hidden="true" width="130" height="29" viewBox="0 0 130 29" fill="white">
...
<ul className=" space-x-8 font-semibold tracking-wide text-sm flex">
  ...
  <li><Link to="#" className="hover:text-gray-600">Mobile</Link></li>
  <li><Link to="#" className="hover:text-gray-600">TV & AV</Link></li>
  <li><Link to="#" className="hover:text-gray-600">Appliances</Link></li>
  <li><Link to="#" className="hover:text-gray-600">Computing & Displays</Link></li>
