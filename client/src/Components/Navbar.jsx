...
<ul className=" md:flex space-x-8 font-semibold tracking-wide text-sm">
  <li><a href="#" className="hover:text-gray-600">Shop</a></li>
  <li><a href="#" className="hover:text-gray-600">Mobile</a></li>
  <li><a href="#" className="hover:text-gray-600">TV & AV</a></li>
  <li><a href="#" className="hover:text-gray-600">Appliances</a></li>
  <li><a href="#" className="hover:text-gray-600">Computing & Displays</a></li>
