...
useEffect(() => {
  ...
  return (
    <nav
      className={`mx-1 h-[64px] xl:h-[7.3655vw] flex gap-[2.22222222vw] items-center w-full top-0 p-[0_8px_0_8px] xl:p-[2.2222vw_1.1111vw_0vw_1.1111vw]
      ${
        isNavPage
          ? isListHovered
    ...
    >
      ...
      <div className='cursor-pointer'>
        <Link to={'/'}>
          <svg className='' focusable="false" aria-hidden="true" width="130" fill='currentColor' height="29" viewBox="0 0 130 29" data-di-res-id="7242691b-1854f892" data-di-rand="1758191581070">
      ...
      <div className='h-full items-center flex justify-end w-full xl:justify-between relative'>
        <div className='h-full items-center hidden xl:flex flex-1'>
          <ul
            className='list-none flex text-[17px] font-bold'
            onMouseEnter={() => setIsListHovered(true)}
            onMouseLeave={() => setIsListHovered(false)}
          >
            <li className='list-item '><NavLink className='p-[.83333vw_.83333vw_1.1111vw_.83333vw]' to='/shop'>Shop</NavLink></li>
            <li><NavLink className='p-[.83333vw_.83333vw_1.1111vw_.83333vw]' to='/mobile'>Mobile</NavLink></li>
            <li><NavLink className='p-[.83333vw_.83333vw_1.1111vw_.83333vw]' to='/av&tv'>AV & TV</NavLink></li>
            <li><NavLink className='p-[.83333vw_.83333vw_1.1111vw_.83333vw]' to='/appliances'>Appliances</NavLink></li>
            <li><NavLink className='p-[.83333vw_.83333vw_1.1111vw_.83333vw]' to='/computing&displays'>Computing & Displays</NavLink></li>
            <li><NavLink className='p-[.83333vw_.83333vw_1.1111vw_.83333vw]' to='/accessories'>Accessories</NavLink></li>
          </ul>
        </div>
